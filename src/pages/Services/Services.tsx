...
export default function Services() {
  ...
  if (isError)
    return <div className="text-center py-10">Error loading services</div>;

  return (
    <div className="wrapper mt-10">
      <div className="flex flex-col md:flex-row gap-3">
        {/* Desktop sidebar */}
        {/* <div className="hidden md:block md:w-1/4 md:sticky md:top-44 md:self-start h-[75vh] overflow-y-auto">
                    <div className="p-4">
        ...
        <div className="hidden md:block md:w-1/4 md:sticky md:top-44 md:self-start h-[75vh] overflow-y-auto  shadow-lg rounded-lg p-4">
          ...
          {isSidebarOpen && (
            ...
            >
              <div className="p-4 bg-primary-foreground">
                <Button
                  variant="ghost"
                  className="mb-4 absolute top-5 right-0"
            ...
            <div className="relative w-3/4 bg-background h-full shadow-lg flex flex-col">
                ...
                <div className="p-6 overflow-y-auto mt-4">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-semibold">Filters</h2>
                        <Button variant="ghost" size="sm" onClick={() => handleRadioChange('all')}>
                            Reset
                        </Button>
                    </div>
                    <RadioGroup value={selectedCategory} onValueChange={handleRadioChange}>
                        {categories.map(category => (
                            <div key={category.value} className="flex items-center gap-2 py-2 border-b rounded-md px-2 transition-colors">
                                <RadioGroupItem value={category.value} id={category.value} />
                                <Label htmlFor={category.value} className="cursor-pointer">
                                    {category.name}
                                </Label>
                ...
                <Pagination>
                  <PaginationContent>
                    ...
                    <PaginationItem>
                      <PaginationNext
                        onClick={() =>
                          handlePageChange(meta.nextPage || meta.totalPages)
                        }
                        className={
                          !meta.hasNextPage
                            ? "pointer-events-none opacity-50"
