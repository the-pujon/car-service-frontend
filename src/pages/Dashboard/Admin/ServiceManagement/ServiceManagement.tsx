...
import { categories, getCategoryName } from "@/utils/categoriesName";
    ...
    <div className="text-white min-h-screen p-5 relative">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-2 mb-6">
        <div className="flex flex-col gap-2">
          <h2 className="text-3xl md:text-4xl font-bold">Service Management</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6">
        ...
        <Select
          value={sortOrder}
          onValueChange={(value) => setSortOrder(value as "high" | "low" | "")}
        >
          <SelectTrigger className="bg-white text-black">
                  ...
                  <TableCell className="flex gap-2">
                    <Dialog>
                      ...
                      {serviceId === service._id && (
                        <UpdateService serviceId={serviceId as string} />
                      )}
                    </Dialog>
                    <AlertDialog>
